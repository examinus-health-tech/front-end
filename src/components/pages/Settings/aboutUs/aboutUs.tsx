...
import { Box, HStack, IScrollViewProps, Image, ScrollView, Text, VStack, View, StatusBar, Actionsheet, useDisclose, Pressable, Center } from 'native-base';
...
export function AboutUs() {
  ...
  return (
    <View testID="screen-about-us" flex={1}>
      ...
      <Actionsheet isOpen={isReviewOpen} onClose={onReviewClose}>
          ...
          <VStack w="100%" alignItems="center" space={4}>
            ...
            {selectedRating > 0 && (
              <VStack w="100%" space={3} mt={4}>
                ...
                <TouchableOpacity onPress={onReviewClose} activeOpacity={0.8}>
